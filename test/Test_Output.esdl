...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" id="e4e87ec0-2c1c-4569-afc8-752bbddadbcc" description="" esdlVersion="v2210" name="New Energy System" version="14">
  <energySystemInformation xsi:type="esdl:EnergySystemInformation" id="bc6a175b-6e55-44b4-a664-d0fda633920a">
    <quantityAndUnits xsi:type="esdl:QuantityAndUnits" id="543ca49f-c1bf-4f20-95e6-3dd6e2bc2e28">
      <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" perMultiplier="KILO" physicalQuantity="ENERGY" multiplier="KILO" unit="WATTHOUR" perUnit="WATT" id="eb07bccb-203f-407e-af98-e687656a221d" description="Energy in kWh per kW"/>
      <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="ENERGY" multiplier="GIGA" unit="JOULE" id="1a81a2e7-6ad4-472a-b8e5-973f82f454e9" description="Energy in GJ"/>
    </quantityAndUnits>
    ...
    <area xsi:type="esdl:Area" id="GM0716" scope="MUNICIPALITY" name="Tholen">
      <KPIs xsi:type="esdl:KPIs" id="TotalExportedEnergyID" description="">
        ...
        <kpi xsi:type="esdl:DoubleKPI" id="8b847e8b-c072-4e0e-a53e-5f0f97049c89" name="Total energy production, per energy carrier [Joule] - Electricity" value="103729392784.19324">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="JOULE" description="Electricity"/>
        </kpi>
        ...
        <kpi xsi:type="esdl:DoubleKPI" id="b39913f0-3082-40a5-8b32-b6e64654dcc2" name="Total imported energy [Percentage] - Electricity" value="55.2565529002016">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="PERCENT" description="Electricity"/>
        </kpi>
        <kpi xsi:type="esdl:DoubleKPI" id="d955682e-dfcb-4de8-b865-e7bc7bc06811" name="Number of hours with energy import [Hour] - Electricity" value="6299.0">
          <quantityAndUnit xsi:type="esdl:QuantityAndUnitType" unit="HOUR" description="Electricity"/>
        </kpi>
      ...
      <asset xsi:type="esdl:PVInstallation" name="PVInstallation_1907" surfaceArea="7979" id="1907945a-5ffe-4c08-b9ce-9bc8689f943c" state="DISABLED">
        <costInformation xsi:type="esdl:CostInformation" id="c1ec6af9-b62b-40db-acdc-a84a7d2692ee">
          <investmentCosts xsi:type="esdl:SingleValue" id="2731c2a1-f70b-4db8-9f70-f531121d3745" value="871.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" perMultiplier="KILO" physicalQuantity="COST" unit="EURO" perUnit="WATT" id="ed551dad-660a-4f65-84c6-3e108241a178" description="Cost in EUR/kW"/>
          </investmentCosts>
        </costInformation>
        ...
        <KPIs xsi:type="esdl:KPIs" id="277cb1ba-80d1-4796-aa94-67a852059c69">
          <kpi xsi:type="esdl:IntKPI" id="TEACOS_Was_Optional_PVInstallation_1907" name="1" value="1"/>
          <kpi xsi:type="esdl:IntKPI" id="TEACOS_Inversted_W_PVInstallation_1907" name="TEACOS_Inversted_W_PVInstallation_1907"/>
          <kpi xsi:type="esdl:IntKPI" id="TEACOS_Was_Optional_PVInstallation_1907" name="1" value="1"/>
          <kpi xsi:type="esdl:IntKPI" id="TEACOS_Inversted_W_PVInstallation_1907" name="TEACOS_Inversted_W_PVInstallation_1907"/>
        </KPIs>
        <port xsi:type="esdl:OutPort" id="4c3f787e-df4f-4ab8-93ab-93dcde9827e2" connectedTo="ad335aa5-2ebc-4148-85ac-b4276f64b7fc" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="Out">
          <profile xsi:type="esdl:InfluxDBProfile" endDate="2020-01-01T00:00:00.000000+0100" id="6fc38691-9d02-4f58-bfde-455eb641cb82" database="energy_profiles" startDate="2019-01-01T00:00:00.000000+0100" filters="" field="Zon_deBilt" measurement="standard_profiles" host="http://influxdb" port="8086" multiplier="0.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="ENERGY" multiplier="KILO" unit="WATTHOUR" id="9d70cc41-750c-4c77-9f80-4bd89bc9020b" description="Energy in kWh"/>
          </profile>
        </port>
      ...
      <asset xsi:type="esdl:ElectricityDemand" name="ElectricityDemand_2f52" id="2f528ef6-186e-4937-9967-d277f78e858a">
        <port xsi:type="esdl:InPort" connectedTo="bdb51e39-6cbf-48b1-84ab-bc342c4449f0" id="54c99cc4-fbc2-4d94-bc78-994eedb2cded" carrier="279b10f4-c971-454d-9390-60a6970ab471" name="In">
          <profile xsi:type="esdl:InfluxDBProfile" endDate="2019-12-31T22:00:00.000000+0000" id="0de8679f-b0c1-4b17-830e-25955007bb2c" database="energy_profiles" startDate="2018-12-31T23:00:00.000000+0000" filters="" field="E3C" measurement="standard_profiles" host="http://influxdb" port="8086" multiplier="100.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" physicalQuantity="ENERGY" multiplier="GIGA" unit="JOULE" id="5cd6a897-1ee4-4963-ac07-e4d917c65ab7" description="Energy in GJ"/>
          </profile>
        </port>
